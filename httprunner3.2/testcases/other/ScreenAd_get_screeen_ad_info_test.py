...
class TestCaseScreenAdGetScreeenAdInfo(HttpRunner):  #更改为与接口相关的名字，方便以后引用（例如引用login接口需要先导入类名）
    ...
    teststeps = [
        ...
        Step(
            RunRequest("get_screeen_ad_info")
            .with_variables(
                **{   
                }
                )
...
if __name__ == "__main__":
    TestCaseScreenAdGetScreeenAdInfo().test_start()